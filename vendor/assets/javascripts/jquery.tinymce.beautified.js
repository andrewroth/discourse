/* I really hate minified code, so the minified tinymce code here was run through http://www.jspretty.com/
   for what you see below */
(function(c) {
    var b, e, a = [],
        d = window;
            ...
            if (n !== b) {
                ...
                m.each(function(p, q) {
                    ...
                    if (o = tinyMCE.get(q.id)) {
                      console.log("before setContent o: ", o, " n: ", n);
                        o.setContent(n)
                    }
                })
            } else {
