var item_id = tinyMCEPopup.getParam("item_id");
var thumbs_url = '/items/' + item_id + '/thumbs';
var upload_url = '/assets?item_id=' + item_id;
var ImageDialog = {
	preInit : function() {
		var url;
...
{
 var formObj = formElement(); formObj.src.value = url;
...
function ts_onload()
{
 ...
 $('image_upload_form').setAttribute("action", upload_url);
}
