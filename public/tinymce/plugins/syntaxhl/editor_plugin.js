...
(function() {
	...
	tinymce.create('tinymce.plugins.SyntaxHL', {
      ...
      ed.onInit.add(function() {
        /* I don't know why content_css isn't working in the main tiny_mce.js, but it seems to get
        * here.  So I will set it here. -AR */
        if (ed.settings.content_css) {
          tinymce.each(tinymce.explode(ed.settings.content_css), function(u) {
            ed.dom.loadCSS(ed.baseURI.toAbsolute(u));
          });
        }
      });
		},
