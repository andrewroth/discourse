...
(function() {
  ...
  tinymce.create('tinymce.plugins.simpleimagemanagerPlugin', {
    /**
    ...
    init : function(ed, url) {
      // Register the command so that it can be invoked by using tinyMCE.activeEditor.execCommand('mcesimpleimagemanager');
      ed.addCommand('mcesimpleimagemanager', function() {
        ed.windowManager.open({
          file : ed.getParam('simpleimagemanager_dialog_path'),
          width : 900,
          height : 700,
          inline : 1,
          title : "Insert Image"
      ...
      // Register simpleimagemanager button
      ed.addButton('simpleimagemanager', {
        title : 'Upload/Insert Images',
        cmd : 'mcesimpleimagemanager',
        image : url + '/img/simpleimagemanager.png'
      });

      // Add a node change handler, selects the button in the UI when a image is selected
      ed.onNodeChange.add(function(ed, cm, n) {
        cm.setActive('simpleimagemanager', n.nodeName == 'IMG');
      });
    ...
    getInfo : function() {
      return {
        longname : 'simpleimagemanager plugin',
        author : 'SheldonD',
        authorurl : '',
        infourl : '',
        version : "1.0"
  ...
  // Register plugin
  tinymce.PluginManager.add('simpleimagemanager', tinymce.plugins.simpleimagemanagerPlugin);
})();
