<?php
	...
	$mcImageManagerConfig['general.tools'] = "upload,refresh,addfavorite,removefavorite,insert,delete,edit,preview"; // createdir   "filemanager" button if you have "filemanager.urlprefix" configured.
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '/var/www/dev.h3d/current/public/tinymce/plugins/imagemanager/files'; //'files'; // absolute or relative from this script path, required.
